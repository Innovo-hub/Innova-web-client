...
export const getUserWishlist = createAsyncThunk('/get/wishlist',async(_,{rejectWithValue})=>{
    try {
...
export const addToWishlist = createAsyncThunk(
    ...
    async (ProductId, { rejectWithValue }) => {
        try {
            ...
            return rejectWithValue(error.message || "An error occurred while adding to wishlist.");
        }
    }
);
export const removeFromWishlist = createAsyncThunk(
    ...
    async ({ ProductId }, { rejectWithValue }) => {
        try {
            ...
            // Return custom error message if available
            return rejectWithValue(error.message || "An error occurred while removing from wishlist.");
        }
    }
)
const initialState = { 
