            ...
            {status === "loading" ? (
              ...
              allDeals.map((deal, index) => (
                <div key={deal.id || index} className="mb-8">
                  <DealShowCard
                    deal={{
                      ownerImage: deal.BusinessOwnerImage || "https://images.unsplash.com/photo-1539571696357-5a69c17a67c6?q=80&w=1374&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
