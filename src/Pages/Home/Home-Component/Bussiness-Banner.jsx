...
function BussinessBanner() {
  return (
    <div className="relative   w-full   my-8 px-8">{/*containure for all item this part*/}
...
{/* Backgroud colored  for 4cards^^ */}
<div
  className="relative bg-gradient-to-r from-blue-100 via-white to-green-100 rounded-lg shadow-lg p-6 w-full   my-8"
  ...
  <div className="grid lg:grid-cols-4 md:grid-cols-2 sm:grid-cols-1 gap-16 px-10 ">
        ...
        {/* Card 1 */}
          ...
          <div className="flex items-center justify-center w-16 h-16 rounded-full mb-3 border-2 border-white">
            <div className="text-4xl text-white"><CurrencyPoundIcon fontSize="large"/></div>  {/*icone $ */}
          </div>
        ...
        <div
          ...
          className="text-white p-4 rounded-md flex flex-col items-center shadow-md w-26 h-30"
              >
                  {/*circle part */}
          <div className="flex items-center justify-center w-16 h-16 rounded-full mb-3 border-2 border-white">
            <div className="text-4xl"><PeopleAltIcon fontSize="large"/></div>  {/*pepele propfile icon */}
          </div>
        ...
        <div
          ...
          className="text-white p-4 rounded-md flex flex-col items-center shadow-md w-26 h-30"
              >
                  {/*circle part */}
          <div className="flex items-center justify-center w-16 h-16 rounded-full mb-3 border-2 border-white">
            <div className="text-4xl text-white"><ElectricBoltIcon fontSize="large"/></div>  {/*lighting icon */}
          </div>
        ...
        <div
          ...
          className="text-white p-4 rounded-md flex flex-col items-center shadow-md w-26 h-30"
              >
                  {/*circle part */}
          <div className="flex items-center justify-center w-16 h-16 rounded-full mb-3 border-2 border-white">
            <div className="text-4xl text-white"><CheckIcon fontSize="large"/></div>  {/*true icon */}
          </div>
