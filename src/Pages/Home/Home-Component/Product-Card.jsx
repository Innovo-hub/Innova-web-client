...
function ProductCard({ imageSrc, productName, PriceAfterDiscount, Price, Author, inStock, starsNumbers, NumberofRates }) {
  ...
  return (
    <div className="card flex flex-col bg-[#FFFFFF] shadow-lg rounded-xl relative group overflow-hidden">
      ...
      <div className="relative">
        <img className="object-cover w-full h-52" src={imageSrc} alt={productName} />
      ...
      <div className="flex flex-col p-4">
        ...
        <div className="flex items-center gap-2">
          ...
          <h6 className="line-through text-gray-600">${Price}</h6>
        </div>
        ...
        <div className={starsNumbers ? "flex items-center mt-2": "hidden"}>
          ...
          <span className="text-sm text-gray-600 ml-2">({NumberofRates} reviews)</span>
        </div>
      </div>
    </div>
  );
