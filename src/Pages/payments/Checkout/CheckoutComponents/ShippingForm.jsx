    ...
    const fetchShippingDetails = async () => {
      try {
        ...
        const existResponse = await axios.get(
          `${APILINK}/api/shippingaddress/exists`,
          {
  ...
  const handleSubmit = async () => {
    try {
      ...
      if (isExist) {
        ...
        await axios.patch(`${APILINK}/api/shippingaddress/update`, address, {
          headers,
        });
        Swal.fire({
          icon: "success",
        ...
        await axios.post(`${APILINK}/api/shippingaddress/add`, address, {
          headers,
        });
        setIsExist(true);
        Swal.fire({
