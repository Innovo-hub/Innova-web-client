...
const CheckoutPage = () => {
  ...
  // Separate useEffect for fetching order summary
  useEffect(() => {
    ...
    fetchOrderSummary();
  }, [selectedMethod]); // Only depends on selectedMethod

  // Separate useEffect for fetching address
  useEffect(() => {
          ...
          <div className="w-full lg:w-1/2 flex flex-col">
            <div className="bg-white rounded-md p-6">
              <div className="flex justify-between items-center mb-4">
                ...
                <Link
                  to={"/checkOut"}
                  className="border border-[#126090] text-black hover:text-[#126090] rounded-md px-4 py-2 transition-colors"
                >
                  Edit
                </Link>
              </div>
              ...
              <div className="space-y-2 mb-4 p-4">
                <div className="flex justify-between">
                  ...
                  <span className="text-[#126090]">
                    EGP {orderSummary.Subtotal.toFixed(2)}
                  </span>
                </div>
                <div className="flex justify-between">
                  <span className="text-gray-600">Shipping</span>
                  <span className="text-[#126090]">
                    EGP {orderSummary.ShippingDeliveryMethod.toFixed(2)}
                  </span>
                </div>
                <div className="flex justify-between">
                  <span className="text-gray-600">Tax</span>
                  <span className="text-[#126090]">
                    EGP {orderSummary.Taxes.toFixed(2)}
                  </span>
                </div>
              </div>
