    ...
    <>
      ...
      <div className="container mx-auto bg-[#f7f7f7] min-h-[80vh] px-4 py-8">
        <div className="flex justify-between items-center mb-8">
          ...
          <Button variant="outlined" color="error" disabled={!wishlistItems.length}>
            Clear All
          </Button>
        </div>
        ...
        {loading ? (
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
            {wishlistItems.map((item, index) => (
              ...
              key={index}
              imageSrc = {item.ProductHomeImage || "https://images.unsplash.com/photo-1539571696357-5a69c17a67c6?q=80&w=1374&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"}
